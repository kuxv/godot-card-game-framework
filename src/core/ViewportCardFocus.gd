...
#		pass
##		card_focus.custom_minimum_size = _current_focus_source.canonical_size * _current_focus_source.focused_scale * cfc.curr_scale
#		card_focus.custom_minimum_size.y *= 1.25
#		card_focus.size = _current_focus_source.canonical_size * _current_focus_source.focused_scale * cfc.curr_scale
#		card_focus.size.y *= 1.25
#		_focus_viewport.size = _current_focus_source.canonical_size * _current_focus_source.focused_scale * cfc.curr_scale
#		focus_info.size.x = _current_focus_source.canonical_size.x * _current_focus_source.focused_scale * cfc.curr_scale
